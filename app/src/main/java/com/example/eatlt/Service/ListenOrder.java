package com.example.eatlt.Service;
...
import com.example.eatlt.OrderStatus;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        builder.setAutoCancel(true)
                ...
                .setContentText("Order #"+key+"was update status to "+ Commom.convertCodeToStatus(request.getStatus()))
                .setContentInfo("Info")
